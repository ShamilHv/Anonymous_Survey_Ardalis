...
using Anonymous_Survey_Ardalis.Web.Comments;
  ...
  CancellationToken cancellationToken)
{
  ...
  if (result.IsSuccess)
  {
    Response = new AdminRecord(result.Value.Id, result.Value.AdminName, result.Value.Email, result.Value.SubjectId, result.Value.CreatedAt);
  }
}
