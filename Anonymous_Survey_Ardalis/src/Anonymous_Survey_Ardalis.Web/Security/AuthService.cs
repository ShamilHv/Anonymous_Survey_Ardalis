...
public class AuthService : IAuthService
{
    ...
    public async Task<AdminRecord> GetCurrentAdmin()
    {
      ...
      return new AdminRecord(admin.Id, admin.AdminName, admin.Email, admin.SubjectId,admin.DepartmentId, admin.CreatedAt, admin.Role);
    }
    ...
    public async Task<Admin?> RegisterAsync(AuthRequest request)
{
    ...
    int? sanitizedSubjectId = request.SubjectId > 0 ? request.SubjectId : null;
    int? sanitizedDepartmentId = request.DepartmentId > 0 ? request.DepartmentId : null;
...
// }
    ...
    public async Task<AuthResponse?> LoginRequestAsync(LoginRequest loginRequest)
    {
        ...
        {
            Admin = new AdminRecord(admin.Id, admin.AdminName, admin.Email, admin.SubjectId,admin.DepartmentId, admin.CreatedAt, admin.Role),
